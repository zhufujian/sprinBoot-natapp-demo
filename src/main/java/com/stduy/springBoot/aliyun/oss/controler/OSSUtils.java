...
package com.stduy.springBoot.aliyun.oss.controler;
...
public class OSSUtils {
    static Logger logger = Logger.getLogger(OSSUtils.class);
    ...
    private static String accessKeyId = "LTAIQawS58OzpbZw";
    private static String accessKeySecret = "XXXXXXXXXXX";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "moli-test-api";
...
*/
            ...
            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
            String fileKey = "barCode.png";
            ossClient.putObject(bucketName, fileKey, new File(fileKey));
            System.out.println("Object：" + fileKey + "存入OSS成功。");
            
             fileKey = "personFace.jpg";
            ossClient.putObject(bucketName, fileKey, new File(fileKey));
            System.out.println("Object：" + fileKey + "存入OSS成功。");
